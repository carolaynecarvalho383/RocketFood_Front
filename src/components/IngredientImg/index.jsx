...
export function IngredientImg({ ingredientName }) {
  return (
    <Container>
      ...
      {AccentRemover(ingredientName) == 'macarrao' || 'massa' ? <span><img src={pasta} alt={`imagem de ${ingredientName}`} /><span>{ingredientName}</span></span> : ''}
      ...
      {AccentRemover(ingredientName) == 'whisky' || 'whiske' ? <span><img src={whiskey} alt={`imagem de ${ingredientName}`} /><span>{ingredientName}</span></span> : ''}
    </Container>
  )
}