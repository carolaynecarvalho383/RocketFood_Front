...
export function IngredientImg({ ingredientName }) {
  ...
  return (
    <Container>
      ...
      {AccentRemover(ingredientName) == 'macarrao' ? <span><img src={pasta} alt={`imagem de ${ingredientName}`} /><span>{ingredientName}</span></span> : ''}
      ...
      {AccentRemover(ingredientName) == 'clara' ? <span><img src={eggWhite} alt={`imagem de ${ingredientName}`} /><span>{ingredientName}</span></span> : ''}
